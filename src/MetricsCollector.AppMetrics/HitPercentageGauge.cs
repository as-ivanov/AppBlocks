...
namespace MetricsCollector.AppMetrics
{
  public class HitPercentageGauge : IHitPercentageGauge
  {
    ...
    public void Ratio(IMeter numerator, IMeter denominator)
    {
      ...
      _metrics.Measure.Gauge.SetValue(_gaugeOptions, _metricTags, () => new App.Metrics.Gauge.HitPercentageGauge(internalNumerator, denominatorNumerator,
        delegate(MeterValue value)
        {
